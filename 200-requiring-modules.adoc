...
[subs="+quotes,+macros"]
----
[gray]##// Add the following line at the top of lib/util.js##
exports.id = "lib/util";

[gray]##// Add the following line at the top of index.js##
exports.id = "index";
----
...
[subs="+quotes,+macros"]
----
[gray]##// Add the following line in index.js before the console.log##
...
fs.readFile("/etc/passwd", (err, data) => {
  if (err) throw err;
  *exports.data = data;* [gray]##// Will not work.##
});
----
...
[subs="+quotes,+macros"]
----
exports.id = 42; [gray]##// This is ok.##

exports = { id: 42 }; [gray]##// This will not work.##

module.exports = { id: 42 }; [gray]##// This is ok.##
----
...
[gray]##// let exports = module.exports;##

  [gray]##// Your Code...##

[gray]##// return module.exports;##
}
----
...
[subs="+quotes,+macros"]
----
[gray]##~/learn-node $## node print-in-frame 8 Hello
----
+
...
if (require.main === module) {
  [gray]##// The file is being executed directly (not with require)##
}
----
...
[subs="+quotes,+macros"]
----
require("./ascii-art"); [gray]##will show the header.##
require("./ascii-art"); [gray]##will not show the header.##
----
...
----
require("./ascii-art")(); [gray]##will show the header.##
require("./ascii-art")(); [gray]##will also show the header.##
----
